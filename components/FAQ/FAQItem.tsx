...
const FAQItem = ({ faqData }: { faqData: FaqData }) => {
  const { activeFaq, id, handleFaqToggle, quest, ans, duration } = faqData;
  ...
  return (
    <>
        <motion.div
          ...
          className="animate_right flex flex-col border-b border-stroke last-of-type:border-none dark:border-strokedark"
        >
