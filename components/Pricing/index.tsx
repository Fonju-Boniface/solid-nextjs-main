    ...
    <>
      ...
      <section className="overflow-hidden pb-20 pt-15 lg:pb-25 xl:pb-30">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.1 }}
          viewport={{ once: false, amount: 0.2 }} // Ensure animation replays on scroll
          className="animate_top relative mx-auto mt-15 max-w-[1207px] px-4 md:px-8 xl:mt-20 xl:px-0"
        >
          ...
          <div className="grid grid-cols-1 gap-7.5 md:grid-cols-2 lg:grid-cols-3 xl:gap-10">
            ...
            <motion.div
              ...
              className="animate_top animate_top group relative rounded-lg border border-stroke bg-white p-7.5 shadow-solid-10 dark:border-strokedark dark:bg-blacksection dark:shadow-none xl:p-12.5"
            >
